...
const permissionSchema = z.object({
  ...
  resource: z.enum(['AtcSupervisorSala_view', 'AtcMaitre_view', 'DpSupervisor_view', 'DpDespachador_view', 'CocinaChef_view', 'CocinaCocinero_view', 'CocinaMesero_view', 'SeguridadPersonal_view', 'KpiGerente_view']), 
